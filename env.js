...
const BUNDLE_ID = 'com.ruastartreconhece'; // ios bundle id
const PACKAGE = 'com.ruastartreconhece'; // android package name
const NAME = 'Rua Start Reconhece'; // app name
const EXPO_ACCOUNT_OWNER = 'ruastartreconhece'; // expo account owner
const EAS_PROJECT_ID = 'c3e1075b-6fe7-4686-aa49-35b46a229044'; // eas project id
const SCHEME = 'ruastartreconheceApp'; // app scheme
